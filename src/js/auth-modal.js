const authTemplates = {
    login: `
        ...
        <form class="space-y-5 w-full">
            ...
            <button type="submit" class="w-full bg-[#569785] hover:bg-primary text-white py-4 rounded-full font-bold shadow-md transition-all duration-300 transform hover:-translate-y-0.5 mt-2 text-base">Masuk</button>
        </form>
    ...
    signup: `
        ...
        <form class="space-y-5 w-full">
            ...
            <button type="submit" class="w-full bg-[#569785] hover:bg-primary text-white py-4 rounded-full font-bold shadow-md transition-all duration-300 transform hover:-translate-y-0.5 mt-4 text-base">
                Buat akun
            </button>
        </form>
        <div class="relative my-8">
